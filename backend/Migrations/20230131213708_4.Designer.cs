            ...
            modelBuilder.Entity("Show", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Shownr = 1,
                            Afbeelding = "",
                            BeginTijd = new DateTime(2023, 1, 31, 22, 37, 7, 876, DateTimeKind.Local).AddTicks(9300),
                            EindTijd = new DateTime(2023, 1, 31, 22, 37, 7, 876, DateTimeKind.Local).AddTicks(9361),
                            Genre = 1,
                            Leeftijdsgroep = 1,
                            Naam = "Show 1",
                            Zaal = 1
                        ...
                        new
                        {
                            Shownr = 2,
                            Afbeelding = "",
                            BeginTijd = new DateTime(2023, 1, 31, 22, 37, 7, 876, DateTimeKind.Local).AddTicks(9367),
                            EindTijd = new DateTime(2023, 1, 31, 22, 37, 7, 876, DateTimeKind.Local).AddTicks(9370),
                            Genre = 2,
                            Leeftijdsgroep = 2,
                            Naam = "Show 2",
                            Zaal = 2
                        ...
                        new
                        {
                            Shownr = 3,
                            Afbeelding = "",
                            BeginTijd = new DateTime(2023, 1, 31, 22, 37, 7, 876, DateTimeKind.Local).AddTicks(9374),
                            EindTijd = new DateTime(2023, 1, 31, 22, 37, 7, 876, DateTimeKind.Local).AddTicks(9377),
                            Genre = 3,
                            Leeftijdsgroep = 3,
                            Naam = "Show 3",
                            Zaal = 3
